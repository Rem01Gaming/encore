...
const translations = {
  ...
  jv: {
    ...
    dndGameplay: "DND nalika Dolanan",
    ...
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "Ijinke API KernelSU Majeng",
  ...
  pt: {
    ...
    defaultCpuGov: "Governador de CPU Padrão",
  ...
  tr: {
    ...
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "Gelişmiş KernelSU API'sine İzin Ver",
  ...
  de: {
    ...
    killLogger: "Logger Deaktivieren",
    dndGameplay: "DND im Spiel",
    defaultCpuGov: "Standard-CPU-Governor",
    ...
    killLoggerTitle: "Logger Deaktivieren",
    killLoggerDesc: "Diese Option stoppt die Logger-Dienste und deaktiviert Protokolle, wodurch die Leistung verbessert wird.",
    ...
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "Erweiterte KernelSU-API Erlauben",
  ...
  ja: {
    ...
    killLoggerDesc: "このオプションを有効にすると、ロガーサービスが停止し、ログが無効化され、パフォーマンスのオーバーヘッドが削減されます。",
  ...
  zh: {
    ...
    killLogger: "关闭日志",
    dndGameplay: "游戏时请勿打扰",
    defaultCpuGov: "默认CPU调控",
    powersaveCpuGov: "省电CPU调控",
    actionsTitle: "操作",
    supportTitle: "支持我",
  ...
  ko: {
    ...
    dndTitle: "방해 금지 모드",
    dndDesc: "게임 중 방해 금지 모드를 활성화합니다. 알림 및 전화로 인한 방해를 줄여 원활한 게임 플레이가 가능합니다.",
  ...
  vi: {
    ...
    killLoggerWarning: "CẢNH BÁO: Phần mềm phụ thuộc vào dịch vụ logd có thể không hoạt động đúng!",
    dndTitle: "Không làm phiền",
    dndDesc: "Bật chế độ không làm phiền khi chơi game. Hạn chế thông báo và cuộc gọi để bạn có thể tập trung chơi mà không bị gián đoạn.",
    ...
    breadcrumbsModules: "Mô-đun & Quyền",
    breadcrumbsEncore: "Encore Tweaks",
  ...
  hi: {
    ...
    powersaveCpuGov: "पावरसेव CPU गवर्नर",
  ...
  ar: {
    ...
    defaultCpuGov: "الحاكم الافتراضي لوحدة المعالجة المركزية",
    powersaveCpuGov: "حاكم توفير الطاقة لوحدة المعالجة المركزية",
    ...
    killLoggerDesc: "سيؤدي هذا الخيار إلى إيقاف خدمات التسجيل وكتم السجلات، مما يقلل من استهلاك الأداء.",
    ...
    permissionDeniedDesc: "يرجى تمكين واجهة برمجة تطبيقات JavaScript لـ Encore Tweaks في إعدادات MMRL، وإلا فلن يعمل هذا WebUI.",
  ...
  es: {
    ...
    dndGameplay: "DND en Juego",
    defaultCpuGov: "Governor CPU Predeterminado",
