...
const translations = {
  ...
  su: {
    moduleTitle: "Encore Tweaks",
    profileTitle: "Profil ayeuna",
    kernelTitle: "Kernel",
    chipsetTitle: "Chipset",
    androidSDKTitle: "Android SDK",
    settingsTitle: "Setélan",
    dndGameplay: "DND Waktu Maén",
    liteMode: "Mode Lite",
    deviceMitigation: "Ngahindarkeun Masalah Alat",
    defaultCpuGov: "CPU Governor Bawaan",
    powersaveCpuGov: "CPU Governor Hemat Énergi",
    actionsTitle: "Aksi",
    supportTitle: "Dukung Abdi",
    supportDescription: "Encore Tweaks moal mayar, kabéh bisa maké. Tapi mun rék ngadukung, tiasa ngadonasikeun sakumaha mampuhna.",
    dndTitle: "Mode Ulah Ganggu",
    dndDesc: "Aktifkeun mode ulah ganggu waktu maén game. Supaya bébas ti gangguan notifikasi jeung telepon.",
    liteModeTitle: "Mode Lite",
    liteModeDesc: "Pilihan ieu bisa ngurangan panas jeung pamakean daya waktu maén game, ku kituna CPU jeung bagian séjénna teu kudu jalan terus dina frékuénsi nu pangluhurna. Tapi bisa mangaruhan performa game.",
    deviceMitigationTitle: "Ngahindarkeun Masalah Alat",
    deviceMitigationDesc: "Ngahindarkeun sababaraha bug husus alat ku cara ngalakukeun panalungtikan jeung nyaluyukeun supaya leuwih cocog jeung stabil. Ulah diaktipkeun lamun alat anjeun henteu aya masalah waktu dipareuman.",
    permissionDeniedTitle: "Izin Ditolak",
    permissionDeniedDesc: "Mangga aktifkeun JavaScript API pikeun Encore Tweaks dina setélan MMRL. WebUI ieu moal jalan lamun henteu diaktipkeun.",
    breadcrumbsSettings: "Setélan",
    breadcrumbsModules: "Modul & Izin",
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "Idin API KernelSU Tambahan",
    editGamelistTitle: "Edit Daptar Game",
    editGamelistDesc: "Profil performa bakal otomatis jalan lamun salah sahiji game atawa aplikasi di dieu dipaké.",
    saveChanges: "Simpen Robahan",
    cancelChanges: "Batalkeun Robahan",
    saveLogs: "Simpen Log Modul"
  },
  da: {
    moduleTitle: "Encore Tweaks",
  ...
  zh: {
    ...
    deviceMitigationTitle: "设备缓解",
    deviceMitigationDesc: "通过应用特定调整来缓解某些设备专有的漏洞，提升兼容性和稳定性。除非设备关机时出现问题，否则请保持此功能关闭。",
  ...
  lo: {
    moduleTitle: "Encore Tweaks",
    profileTitle: "ໂປຣຟາຍປັດຈຸບັນ",
    kernelTitle: "Kernel",
    chipsetTitle: "Chipset",
    androidSDKTitle: "Android SDK",
    settingsTitle: "ການຕັ້ງຄ່າ",
    dndGameplay: "ຫ້າມລົງແງວເມື່ອກຳລັງເກມ",
    liteMode: "ໂມດແບບເບົາ",
    deviceMitigation: "ການແກ້ໄຂອຸປະກອນ",
    defaultCpuGov: "CPU Governor ມາດຕະຖານ",
    powersaveCpuGov: "CPU Governor ປະຢັດພະລັງງານ",
    actionsTitle: "ການດຳເນີນງານ",
    supportTitle: "ສະໜັບສະໜູນຂ້ອຍ",
    supportDescription: "Encore Tweaks ຈະພວກເຮົາສະໜັບສະໜູນໃຫ້ຟຣີສຳລັບທຸກຄົນ. ແຕ່ທ່ານສາມາດສະແດງຄວາມຫວັງໃຈໂດຍການບໍລິຈາກ.",
    dndTitle: "ໂມດຫ້າມລົງແງວ",
    dndDesc: "ເປີດໂມດຫ້າມລົງແງວເມື່ອເກມ. ຈັດການການແຈ້ງເຕືອນແລະໂທຫາທີ່ຈະບໍ່ໃຫ້ລົງແງວຂັດຈຳກັດ, ເພື່ອໃຫ້ທ່ານເກມໄດ້ຢ່າງລຽບຮຽບ.",
    liteModeTitle: "ໂມດແບບເບົາ",
    liteModeDesc: "ຕົວເລືອກນີ້ຈະຊ່ວຍລົດອຸ່ນເກີນແລະການໃຊ້ພະລັງງານໃນເວລາເກມ ໂດຍອະນຸຍາດ CPU ແລະອຸປະກອນອື່ນໆ ໃຫ້ເດີນເທິງຄວາມຖືກຕ້ອງຕໍ່ລົງໃນຄວາມຖືກຕ້ອງຕໍ່ລົງຢ່າງຕໍ່ເນື່ອງ ແທນທີ່ຈະເດີນໃນຄວາມຖືກຕ້ອງສູງສຸດຕະແຫຼງ. ມັນຈະມີຜົນກະທົບຕໍ່ປະສິດທິພາບເກມ.",
    deviceMitigationTitle: "ການແກ້ໄຂອຸປະກອນ",
    deviceMitigationDesc: "ແກ້ໄຂບັກທີ່ກ່ຽວຂ້ອງກັບອຸປະກອນດ້ວຍການນຳໃຊ້ການປັບປຸງບາງຢ່າງເພື່ອປັບປຸງຄວາມສາມາດໃນການເຂົ້າກັບແລະຄວາມນ່າໃຊ້ໄດ້, ຢ່າໃຊ້ຟີເຈີນນີ້ຫາກອຸປະກອນຂອງທ່ານບໍ່ທຳວຽກຖືກຕ້ອງ.",
    permissionDeniedTitle: "ການອະນຸມັດຖືກປະຕິເສດ",
    permissionDeniedDesc: "ກະລຸນາເປີດ JavaScript API ສໍາລັບ Encore Tweaks ໃນການຕັ້ງຄ່າ MMRL; WebUI ນີ້ຈະບໍ່ສາມາດໃຊ້ງານໄດ້ຫາກບໍ່ເປີດໃຊ້.",
    breadcrumbsSettings: "ການຕັ້ງຄ່າ",
    breadcrumbsModules: "ໂມດູນ & ການອະນຸຍາດ",
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "ອະນຸຍາດ API KernelSU ຂັ້ນສູງ",
    editGamelistTitle: "ແກ້ໄຂລາຍການເກມ",
    editGamelistDesc: "ໂປຣຟາຍປະສິດທິພາບຈະເປີດໃຊ້ເມື່ອມີເກມ ແລະແອັບພິເກຊັນທີ່ຢູ່ໃນລາຍການນີ້ເລີ່ມຕົ້ນ.",
    saveChanges: "ບັນທຶກການປ່ຽນແປງ",
    cancelChanges: "ຍົກເລີກການປ່ຽນແປງ",
    saveLogs: "ບັນທຶກລອກໂມດູນ"
  },
  km: {
    moduleTitle: "Encore Tweaks",
    profileTitle: "ប្រវត្តិរូបបច្ចុប្បន្ន",
    kernelTitle: "Kernel",
    chipsetTitle: "Chipset",
    androidSDKTitle: "Android SDK",
    settingsTitle: "ការកំណត់",
    dndGameplay: "បិទបាំងការជូនដំណឹងពេលលេងហ្គេម",
    liteMode: "របៀបស្រាល",
    deviceMitigation: "ការបង្រួមបញ្ហាឧបករណ៍",
    defaultCpuGov: "CPU Governor ជាមូលដ្ឋាន",
    powersaveCpuGov: "CPU Governor រក្សាប្រាក់ថាមពល",
    actionsTitle: "សកម្មភាព",
    supportTitle: "គាំទ្រខ្ញុំ",
    supportDescription: "Encore Tweaks តែងតែជាឥតគិតថ្លៃសម្រាប់គ្រប់គ្នា។ ប៉ុន្តែអ្នកអាចបង្ហាញការយកចិត្តទុកដាក់ដោយផ្តល់ជាឧបត្ថម្ភ។",
    dndTitle: "របៀបបិទបាំងការជូនដំណឹង",
    dndDesc: "បើករបៀបបិទបាំងការជូនដំណឹងពេលលេងហ្គេម។ កាត់បន្ថយការរំខានពីការជូនដំណឹង និងការហៅទូរស័ព្ទ ដើម្បីអោយអ្នកអាចលេងហ្គេមដែលចូលចិត្តដោយគ្មានរំខាន។",
    liteModeTitle: "របៀបស្រាល",
    liteModeDesc: "ជម្រើសនេះនឹងបន្ថយកំដៅ និងការប្រើថាមពលពេលលេងហ្គេម ដោយអនុញ្ញាតឲ្យ CPU និងបង្គាប់ផ្សេងទៀតដំណើរការនៅកម្រិតប្រេកង់ទាបជាងការរត់នៅកម្រិតខ្ពស់ជាប់ជានិច្ច។ វានឹងមានឥទ្ធិពលទៅលើសមត្ថភាពហ្គេម។",
    deviceMitigationTitle: "ការបង្រួមបញ្ហាឧបករណ៍",
    deviceMitigationDesc: "កាត់បន្ថយកំហុសពិសេសនៅលើឧបករណ៍ដោយអនុវត្តការកែប្រែជាក់លាក់ដើម្បីបង្កើនការចុះផ្សាយ និងភាពទំនុកចិត្ត។ កុំបើកមុខងារនេះទេក្រៅតែលេខឧបករណ៍របស់អ្នកមានបញ្ហាពេលបិទ។",
    permissionDeniedTitle: "ការអនុញ្ញាតបានបដិសេធ",
    permissionDeniedDesc: "សូមបើក JavaScript API សម្រាប់ Encore Tweaks ក្នុងការកំណត់ MMRL; WebUI នេះមិនអាចដំណើរការ​បានទេប្រសិនបើមិនបានបើក។",
    breadcrumbsSettings: "ការកំណត់",
    breadcrumbsModules: "ម៉ូឌុល និងការអនុញ្ញាត",
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "អនុញ្ញាត KernelSU API កម្រិតខ្ពស់",
    editGamelistTitle: "កែសម្រួលបញ្ជីហ្គេម",
    editGamelistDesc: "ប្រវត្តិរូបសមត្ថភាពនឹងដំណើរការក្រោយពីហ្គេមឬកម្មវិធីណាមួយដែលមានក្នុងបញ្ជីនេះត្រូវបានបើក។",
    saveChanges: "រក្សាទុកការផ្លាស់ប្ដូរ",
    cancelChanges: "បោះបង់ការផ្លាស់ប្ដូរ",
    saveLogs: "រក្សាទុកកំណត់ហេតុម៉ូឌុល"
  },
  my: {
    moduleTitle: "Encore Tweaks",
    profileTitle: "လက်ရှိ ပရိုဖိုင်",
    kernelTitle: "Kernel",
    chipsetTitle: "Chipset",
    androidSDKTitle: "Android SDK",
    settingsTitle: "ဆက်တင်များ",
    dndGameplay: "ဂိမ်းကစားစဉ် DND",
    liteMode: "Lite မုဒ်",
    deviceMitigation: "စက်ပစ္စည်း ပြဿနာလျော့ချခြင်း",
    defaultCpuGov: "CPU Governor Default",
    powersaveCpuGov: "CPU Governor စွမ်းအင်စုစည်းမှု",
    actionsTitle: "လှုပ်ရှားမှုများ",
    supportTitle: "ကျွန်ုပ်အား ထောက်ခံပါ",
    supportDescription: "Encore Tweaks ကို လူတိုင်းအတွက် အခမဲ့ဖြစ်စေမည်။ သို့သော် လှူဒါန်းခြင်းဖြင့် သင်၏ စိတ်ပါဝင်စားမှုကို ဖော်ပြနိုင်သည်။",
    dndTitle: "မနှောင့်ယှက်စရာ မုဒ်",
    dndDesc: "ဂိမ်းကစားစဉ် မနှောင့်ယှက်စရာ မုဒ်ကို ဖွင့်ပါ။ အသိပေးချက်များနှင့် ဖုန်းခေါ်ဆိုမှုများမှ ကာကွယ်ကာ ရင်းနှီးမြှုပ်နှံသောဂိမ်းများကို ပျော်မွေ့စွာ ကစားနိုင်ပါသည်။",
    liteModeTitle: "Lite မုဒ်",
    liteModeDesc: "Lite မုဒ်သည် CPU နှင့် အခြားကိရိယာများကို အမြင့်ဆုံးဖ্রိကွင်စီမှာ မပြေးပဲ သင့်တော်သော ဖရိကွင်စီသို့ လျော့ပါးစေကာ အပူနှင့် စွမ်းအင်သုံးစွဲမှုကို လျော့ချပေးသည်။ ဤသည်သည် ဂိမ်းစွမ်းဆောင်ရည်ကို ထိခိုက်စေနိုင်ပါသည်။",
    deviceMitigationTitle: "စက်ပစ္စည်း ပြဿနာလျော့ချခြင်း",
    deviceMitigationDesc: "စက်ပစ္စည်းပေါ်မူတည်၍ ဖြစ်ပေါ်နိုင်သော အမှားများကို တိကျစွာပြင်ဆင်ကာ သင့်လျော်သော နည်းလမ်းများဖြင့် ယုံကြည်စိတ်ချရမှုကို တိုးတက်စေသည်။ သင့်စက်မှာ ပြဿနာရှိသောအခါသာ ဖွင့်ပါ။",
    permissionDeniedTitle: "ခွင့်ပြုချက် ပယ်ချခံရသည်",
    permissionDeniedDesc: "Encore Tweaks အတွက် JavaScript API ကို MMRL ဆက်တင်တွင် ဖွင့်ပါ။ ဤ WebUI သည် မဖြစ်မနေ လိုအပ်ပါသည်။",
    breadcrumbsSettings: "ဆက်တင်များ",
    breadcrumbsModules: "မော်ဂျူးများနှင့် ခွင့်ပြုချက်များ",
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "KernelSU API တိုးချဲ့ခွင့်ပြုပါ",
    editGamelistTitle: "ဂိမ်းစာရင်း ပြင်ဆင်ရန်",
    editGamelistDesc: "ဤစာရင်းတွင် ပါဝင်သော ဂိမ်းများနှင့် အက်ပ်များ စတင်သောအခါ စွမ်းဆောင်ရည်ပရိုဖိုင် ကို ဖွင့်မည်ဖြစ်သည်။",
    saveChanges: "ပြင်ဆင်မှုများ သိမ်းမည်",
    cancelChanges: "ပြင်ဆင်မှုများ ပယ်ဖျက်မည်",
    saveLogs: "မော်ဂျူးမှတ်တမ်းများ သိမ်းမည်"
  },
  hi: {
    moduleTitle: "Encore Tweaks",
  ...
  bn: {
    moduleTitle: "Encore Tweaks",
    profileTitle: "বর্তমান প্রোফাইল",
    kernelTitle: "Kernel",
    chipsetTitle: "Chipset",
    androidSDKTitle: "Android SDK",
    settingsTitle: "সেটিংস",
    dndGameplay: "গেমপ্লের সময় DND",
    liteMode: "লাইট মোড",
    deviceMitigation: "ডিভাইস মিটিগেশন",
    defaultCpuGov: "CPU গভার্নর ডিফল্ট",
    powersaveCpuGov: "CPU গভার্নর পাওয়ার সেভ",
    actionsTitle: "অ্যাকশন",
    supportTitle: "আমাকে সমর্থন করুন",
    supportDescription: "Encore Tweaks সর্বদা সবার জন্য ফ্রি থাকবে। তবে আপনি ডোনেশন দিয়ে সমর্থন দেখাতে পারেন।",
    dndTitle: "ডু নট ডিস্টার্ব মোড",
    dndDesc: "গেম খেলার সময় ডু নট ডিস্টার্ব মোড চালু করুন। নোটিফিকেশন এবং কল থেকে বিরক্তি কমিয়ে গেমটি নির্বিঘ্নে খেলুন।",
    liteModeTitle: "লাইট মোড",
    liteModeDesc: "এই বিকল্পটি গেম খেলার সময় অতিরিক্ত গরম এবং বিদ্যুৎ খরচ কমাবে, CPU এবং অন্যান্য কম্পোনেন্টকে সর্বোচ্চ ফ্রিকোয়েন্সির পরিবর্তে কম ফ্রিকোয়েন্সিতে চালাতে দেয়। এটি গেম পারফরম্যান্সকে সামান্য প্রভাবিত করতে পারে।",
    deviceMitigationTitle: "ডিভাইস মিটিগেশন",
    deviceMitigationDesc: "কিছু নির্দিষ্ট ডিভাইস বাগ মোকাবেলায় নির্দিষ্ট সমন্বয় প্রয়োগ করে সামঞ্জস্যতা এবং নির্ভরযোগ্যতা বাড়ায়, তবে ডিভাইস বন্ধ করার সময় সমস্যা না হলে এটি অক্ষম রাখুন।",
    permissionDeniedTitle: "অনুমতি প্রত্যাখ্যান",
    permissionDeniedDesc: "MMRL সেটিংসে Encore Tweaks এর জন্য JavaScript API চালু করুন; ওয়েব UI এটি ছাড়া কাজ করবে না।",
    breadcrumbsSettings: "সেটিংস",
    breadcrumbsModules: "মডিউল এবং অনুমতি",
    breadcrumbsEncore: "Encore Tweaks",
    breadcrumbsAllowAPI: "উন্নত KernelSU API অনুমোদন করুন",
    editGamelistTitle: "গেম তালিকা সম্পাদনা করুন",
    editGamelistDesc: "প্রোফাইল পারফরম্যান্স তখন সক্রিয় হবে যখন তালিকাভুক্ত কোনও গেম বা অ্যাপ্লিকেশন চালু হবে।",
    saveChanges: "পরিবর্তন সংরক্ষণ করুন",
    cancelChanges: "পরিবর্তন বাতিল করুন",
    saveLogs: "মডিউল লগ সংরক্ষণ করুন"
  },
  ar: {
    moduleTitle: "Encore Tweaks",
