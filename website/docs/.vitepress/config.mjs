...
export default defineConfig({
  ...
  transformPageData(pageData) {
    ...
    pageData.frontmatter.head.push(['meta', { property: "og:title", content: pageData.frontmatter.layout === 'home' ? "Encore Tweaks Magisk Module: Special performance module for your device" : `${pageData.title} | Encore Tweaks` }])
    ...
    pageData.frontmatter.head.push(['meta', { property: "twitter:title", content: pageData.frontmatter.layout === 'home' ? "Encore Tweaks Magisk Module: Special performance module for your device" : `${pageData.title} | Encore Tweaks` }])
