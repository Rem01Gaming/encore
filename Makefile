...
aarch64:
	...
	clang -Wall -Wextra -pedantic -O2 -o ./module/system/bin/encore-service ./src/encore-service.c
...
aarch32:
	sed -i "s/versionCode=.*/versionCode=$(version)/" ./module/module.prop
	clang --target=armv7a-linux-androideabi -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -Wall -Wextra -pedantic -O2 -o ./module/system/bin/encore-service ./src/encore-service.c
	strip ./module/system/bin/encore-service
	cp LICENSE gamelist.txt ./module
